...
const insights: Insight[] = [
  {
    ...
    iconColor: "#0EA5E9",
    tag: "Clima",
    title: "Chuvas fortes em Sao Paulo",
    description: "Seu seguro auto cobre danos por alagamento e quedas de arvore. Dirija com cuidado.",
  ...
  },
  {
    ...
    iconColor: "#0D9488",
    tag: "Economia",
    title: "Voce economizou R$ 2.400",
    description: "Comparado ao mercado, suas apolices custam 18% menos. Seu historico ajuda!",
    action: "Ver detalhes",
  },
  {
    id: "tip",
    ...
    iconColor: "#6366F1",
    tag: "Dica",
    title: "Instale o rastreador e ganhe 12% off",
    description: "Motoristas com rastreador tem desconto na renovacao. Ativacao gratuita.",
    action: "Saiba mais",
  },
  {
    id: "protection",
    ...
    iconColor: "#0D9488",
    tag: "Protecao",
    title: "Cobertura de terceiros ativa",
    description: "Hoje voce esta protegido contra danos a terceiros ate R$ 200.000.",
  },
];
