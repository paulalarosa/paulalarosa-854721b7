...
const webProjects = [
  {
    id: "website",
    titleKey: "lab.projects.website.title",
    descKey: "lab.projects.website.desc",
    tagsKey: "lab.projects.website.tags",
  },
  {
    id: "portfolio",
    titleKey: "lab.projects.portfolio.title",
    descKey: "lab.projects.portfolio.desc",
    tagsKey: "lab.projects.portfolio.tags",
  },
  {
    id: "microsaas",
    titleKey: "lab.projects.microsaas.title",
    descKey: "lab.projects.microsaas.desc",
    tagsKey: "lab.projects.microsaas.tags",
  },
  {
    id: "dashboard",
    titleKey: "lab.projects.dashboard.title",
    descKey: "lab.projects.dashboard.desc",
    tagsKey: "lab.projects.dashboard.tags",
  },
];
...
const designProjects: DesignProject[] = [
  {
    ...
    sector: "HealthTech",
    description:
      "Super app de saúde com rede de especialistas, agendamento inteligente, acompanhamento de consultas e gestão de coparticipação.",
    ...
    insights: [
      {
        label: "Dashboard",
        annotation:
          "Hierarquia visual progressiva: HealthRing captura atenção primeiro, depois direciona para ações prioritárias — reduzindo cognitive load.",
      },
      {
        label: "Busca de Rede",
        annotation:
          "Filtros contextuais aparecem apenas quando relevantes. Menos escolhas simultâneas = mais conversão.",
      },
      {
        label: "Consultas",
        annotation:
          "Timeline com feedback visual em tempo real. Confirmação em 2 etapas elimina cancelamentos acidentais.",
      },
      {
        label: "Perfil",
        annotation:
          "Carteirinha digital com dados críticos above the fold. Design orientado a situações de urgência.",
      },
    ],
  },
  {
    ...
    sector: "InsurTech",
    description:
      "App de seguro pessoal com ShieldScore proprietário, visualização de cobertura em órbita, gestão de apólices e sinistros simplificada.",
    ...
    insights: [
      {
        label: "ShieldScore",
        annotation:
          "Transforma dado abstrato em métrica emocional tangível — aumenta engajamento e percepção de valor.",
      },
      {
        label: "Coverage Orbit",
        annotation:
          "Metáfora de órbita comunica proteção ao redor do usuário. UX que gera confiança sem uma linha de copy.",
      },
      {
        label: "Apólices",
        annotation:
          "Documentos densos em cards escaneáveis. Redução de 70% no tempo para encontrar informação crítica.",
      },
      {
        label: "Sinistro",
        annotation:
          "Fluxo em 3 etapas com save automático — desenhado para momentos de estresse emocional alto.",
      },
    ],
  },
  {
    ...
    sector: "HealthTech",
    description:
      "App de plano de saúde com HealthRing animado, Dynamic Island nativo, agenda de consultas e carteirinha digital integrada.",
    ...
    insights: [
      {
        ...
        annotation:
          "Notificações do plano aparecem no componente nativo certo — respeita o design language do iOS.",
      },
      {
        label: "HealthRing",
        annotation:
          "Animação procedural baseada em dados reais. Gamificação sutil que aumenta retenção.",
      },
      {
        label: "Agenda",
        annotation:
          "Calendário + lista com switching fluido. Context preservation: nenhum dado se perde na transição.",
      },
      {
        label: "Coberturas",
        annotation:
          "Ícones customizados por especialidade e linguagem visual clara para cobertura ativa vs carência.",
      },
    ],
  },
  {
    ...
    description:
      "Plataforma para corretores de seguros com CRM de clientes, gestão de apólices, relatórios analíticos e academia de capacitação.",
    ...
    insights: [
      {
        label: "Dashboard",
        annotation:
          "KPIs acima do fold com drill-down progressivo. Decisão rápida para corretores em campo.",
      },
      {
        label: "Clientes",
        annotation:
          "Search, filtros e preview inline eliminam navegação desnecessária. CRM enterprise simplificado.",
      },
      {
        label: "Apólices",
        annotation:
          "Status por cor + tipografia hierárquica: corretor localiza apólices críticas em menos de 3 segundos.",
      },
      {
        label: "Academy",
        annotation:
          "LMS integrado ao fluxo de trabalho — capacitação no contexto de uso, não em plataforma separada.",
      },
    ],
  },
  {
    ...
    sector: "E-commerce",
    description:
      "App de e-commerce para marca de streetwear com experiência editorial, drops exclusivos e navegação por bottom nav fluido.",
    ...
    insights: [
      {
        label: "Home",
        annotation:
          "HeroBanner editorial + Marquee Strip — linguagem de revista de moda. Diferenciação clara dos concorrentes.",
      },
      {
        label: "Explore",
        annotation:
          "ProductCards em proporção 3:4 — aspecto ratio que maximiza percepção de qualidade do produto.",
      },
      {
        label: "Drops",
        annotation:
          "Countdown + estoque em tempo real cria urgência autêntica. Dark mode exclusivo nessa seção.",
      },
      {
        label: "Bag",
        annotation:
          "Checkout por gestos — swipe para remover, tap para quantidade. Menos fricção = menos abandono.",
      },
    ],
  },
];
...
const PhoneFrame = ({
  ...
  return (
    <motion.div
      ...
      style={{ width: 272 }}
      animate={
        isSelected ? { y: -8, scale: 1.08, opacity: 1 } : { y: 0, scale: 0.97, opacity: 0.6 }
      }
                        ...
                        {project.insights.map((_, i) => (
                          <motion.button
                            ...
                            animate={{
                              ...
                              backgroundColor:
                                i === insightIndex ? project.accentColor : "rgba(255,255,255,0.25)",
                            }}
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            A fusão da precisão técnica com o design estratégico para criar experiências digitais de
            alto impacto.
          </p>
