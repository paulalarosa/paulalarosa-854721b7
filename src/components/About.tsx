    ...
    <section id="about" className="py-24 bg-secondary">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="font-serif text-4xl md:text-5xl font-semibold text-primary mb-4">{t('about.title')}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto items-start">
          ...
          <div>
            <h3 className="font-serif text-2xl font-semibold text-primary mb-6">{t('about.highlights')}</h3>
            <div className="grid grid-cols-1 gap-4">
              {highlights.map((item, index) => (
                <div key={index} className="flex items-center gap-4 p-4 bg-background rounded-lg border border-border hover:border-accent/30 transition-base">
